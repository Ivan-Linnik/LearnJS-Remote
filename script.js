...
// Это происходит потому что работает как delete obj.key - удаляется пара ключ:значение, для
...
// let arr = [1, 2, 5];
// console.log(arr);
// arr.splice(-1, 0, 3, 4); // начиная c индекса -1 (перед последним элементом (или после с конца)) удалить 0 элементов,
