...
// Метод slice
// его снитексис arr.slice(start, end) - он возвращает новый массив, в который копирует элементы
...
// метод arr.reduceRight() hf,jnftn точно также, но проходит по массиву справа налево.
